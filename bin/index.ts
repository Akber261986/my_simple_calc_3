...
const answer = await inquirer.prompt([
    {name: "no1",type: "number",message: "Your First Number"},

    {name: "no2",type: "number",message: "Your Second Number"},

    {name: "oprator",type: "list",message: "Slect Your Oprator",choices: ['add', 'sub', 'mult', 'div']}
])
